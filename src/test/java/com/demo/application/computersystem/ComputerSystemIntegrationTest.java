...
class ComputerSystemIntegrationIT {
    ...
    @Test
    @WithMockUser(roles = "MY_APP_ADMIN")
    void testCreateComputerSystemForbiddenForNonUserRole() throws Exception {
        mockMvc.perform(post("/api/v1/computer-systems")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(testDto)))
    ...
    @Test
    @WithAnonymousUser
    void testCreateComputerSystemUnauthorizedWhenUnauthenticated() throws Exception {
        mockMvc.perform(post("/api/v1/computer-systems")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(testDto)))
